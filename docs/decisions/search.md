...
regeneration rule — is pinned in `apps/mcp/src/search/CONTRACT.md`, "Channel-day
notes: one sub-document per message", the way every other shape in this file
is pinned there rather than argued twice.
