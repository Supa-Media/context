// Split out of `preview.test.ts`: crawler detection, which routes get their
// own card, `renderPreviewHtml`'s tags, `escapeHtml`, `previewFromProfile`,
// and the OG card asset. `shareLinks.test.ts` covers share and team links;
