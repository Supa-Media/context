 ...
 * `worker/`. This module covers the credential, the rate limit, routing, a
 * deployment with no Workers AI binding, a body that declares no length,
 * and the body's own checks. `transcribing.test.ts` covers transcribing a
 * chunk and audio never leaving this process. `fixtures.ts` holds the
