...
check("19 tools listed", tools.result?.tools.length === 19);
...
check("modern tools/list works", modernList.status === 200 && modernList.body.result?.tools.length === 19);
check(
...
check(
  ...
  (await rpc("priv-token", "tools/list")).result?.tools.length === 19
);
