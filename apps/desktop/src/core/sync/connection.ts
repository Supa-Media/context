 ...
 *
 * So the mechanism is the one `plugins/context` already ships and this repository
...
/** What a refresh answers with. Mirrors `plugins/context`'s `postToken`. */
...
export class GatewayConnection {
  ...
  async #renew(record: ConnectionRecord): Promise<string | null> {
    ...
    /*
      ...
      `plugins/context`'s `accessTokenFor`.
    */
