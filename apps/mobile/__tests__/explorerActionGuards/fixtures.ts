...
/** Every mounted root awaiting cleanup, shared with files in this folder that mount their own. */
export const roots: (() => void)[] = [];
afterEach(() => {
 ...
 */
export const ROOT_LISTING: FolderListing = {
  path: "",
...
export const PROJECTS_LISTING: FolderListing = {
  path: "1-projects",
  folderDefault: "private",
  entries: [
    {
 ...
 */
export function mountSwitchable(): {
 ...
 */
export function openRowMenu(container: HTMLElement, name: string): void {
...
export function pressMenuItem(label: string): void {
...
export const shareDialogFor = (name: string) =>
 ...
 */
export function rowNode(container: HTMLElement, name: string): HTMLElement {
 ...
 */
export function drag(from: HTMLElement, onto: HTMLElement): void {
  act(() => {
