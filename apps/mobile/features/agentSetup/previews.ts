...
export const AGENT_SETUP_PREVIEWS = {
  ...
  "guide-claude-stick": { title: "Guide · Claude 4 · Make it stick", ...connect("claude", 3) },
  "guide-claude-bring": { title: "Guide · Claude 5 · Bring over", ...bring("claude", { kind: "pick" }) },
  "guide-claude-bring-live": {
    title: "Guide · Claude 5 · Notes arriving",
    ...bring("claude", live({ kind: "writing" }, 4, NOTES.slice(0, 2))),
  },
  "guide-claude-no-write": {
    title: "Guide · Claude 5 · Stalled, nothing written",
    ...bring("claude", live({ kind: "stalled-no-write" }, 3, [])),
  },
  "guide-claude-nothing": {
    title: "Guide · Claude 5 · Stalled, nothing at all",
