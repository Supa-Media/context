...
import { showTableSource, writingTable } from "./livePreview/writingTable";
...
import { tableGrids, tableLines, type CellRun, type TableGrid } from "./livePreview/tableModel";
export {
  alignmentsIn,
  tableGrids,
  tableLines,
...
import {
  ...
  regionOf,
  spanOf,
} from "./livePreview/gridDom";
export { focusGridCell } from "./livePreview/gridDom";
import { makeCellEditable } from "./livePreview/cellEditing";
