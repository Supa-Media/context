...
export function FolderView({
  ...
  /**
   * Where the page reads and changes its children's properties, for the List
   * and Board views and a project's property line. Absent where this device
  ...
  */
  ...
  // How wide the page is, for the one view allowed past the note's measure: a board.
      ...
      */}
      <View style={styles.column} testID="folder-column">
        {/*
          ...
          somebody's bucket. It is the *fallback* now: a folder whose front note
          has a title is titled by it, and the title opens that note — see
          `folderPage/FolderPage.tsx`, which also draws the Files · List · Board
